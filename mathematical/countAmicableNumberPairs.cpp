//to count amicable no pairs in an array
...
int countAmicableNumberPairs(int arr[], int n) {
    unordered_set<int> s;
    int count = 0;
    for (int i=0; i<n; i++)
        s.insert(arr[i]);
...
int main() {
    ...
    cout<<countAmicableNumberPairs(arr1, n1)<<endl;
    int arr2[] = {2620, 2924, 5020, 5564, 6232, 6368};
    int n2 = sizeof(arr2)/sizeof(arr2[0]);
    cout<<countAmicableNumberPairs(arr2, n2)<<endl;
    return 0;
}
